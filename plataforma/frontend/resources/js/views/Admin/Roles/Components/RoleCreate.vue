...
const submitForm = () => {
    form.post('/administrador/roles/store/', {
...
<template>
    <BaseDrawer v-model:show="show" title="Crear Rol" subtitle="Agregar un nuevo rol" icon="pi pi-tags"
        confirmLabel="Guardar Rol" :loading="form.processing" :disabled="!form.isDirty || !form.name"
