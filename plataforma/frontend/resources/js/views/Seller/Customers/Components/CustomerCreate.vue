...
const submitForm = () => {
    form.post("/vendedor/clientes/store/", {
        onSuccess: () => {
            show.value = false
            form.clearErrors()
            form.reset()
...
<template>
    <BaseDrawer v-model:show="show" title="Registrar Nuevo Cliente"
        subtitle="Completa los datos para crear una nueva cuenta." icon="pi pi-user-plus" confirmLabel="Guardar Cliente"
