...
const submitForm = () => {
    ...
    form.post('/vendedor/clientes/update/', {
        data: data,
        onSuccess: () => {
            show.value = false
            form.clearErrors()
...
<template>
    <BaseDrawer v-model:show="show" title="Editar Cliente" subtitle="Actualiza los datos del cliente"
        icon="pi pi-user-edit" confirmLabel="Actualizar Cliente"
        :loading="form.processing"
        :disabled="!form.isDirty || !form.first_name || !form.last_name || !form.email "
