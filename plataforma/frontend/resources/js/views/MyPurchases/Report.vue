        ...
        <div class="p-4 md:p-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <Button icon="pi pi-file-excel" label="Exportar Excel" severity="success" :loading="downloading"
                    @click="exportExcel('/mis-compras/reporte/export/', $page.props.mypurchases.filters || {})" />
            </div>
            ...
            <EnhancedDataTable :data="props.mypurchases" :headers="headers" :sortable-columns="sortableColumns"
